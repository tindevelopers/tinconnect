...
const Index: React.FC = () => {
  ...
  useEffect(() => {
    // Redirect authenticated users to the enhanced dashboard
    if (!loading && user) {
          ...
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              ...
              <span className="block text-blue-600">
                TIN Video Conferencing
              </span>
            </h1>
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              Multi-tenant video conferencing platform with real-time
              collaboration features, built for modern teams and organizations.
            </p>
            ...
            <div className="mt-10">
              <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Crystal clear video powered by AWS Chime SDK
                  </p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-600 mb-4">
                Professional multi-tenant video conferencing platform built for
