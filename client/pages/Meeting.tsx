        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div>
            ...
            <p className="text-sm text-gray-300">
              Meeting ID: {meetingInfo.meetingId} | Joined as:{" "}
          ...
          <CardContent className="text-center space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-gray-600">
                Meeting ID:{" "}
                <span className="font-mono">{meetingInfo.meetingId}</span>
              </p>
              {joinMethod && (
            ...
            <div className="pt-4">
              <p className="text-sm text-gray-500">
                This is a placeholder meeting interface. In a production app,
                this would show the actual video conferencing interface.
              </p>
            </div>
          </CardContent>
        </Card>
